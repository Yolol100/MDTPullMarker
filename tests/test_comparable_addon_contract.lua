...
assert(compatibility:find("MDT 6.2.5", 1, true), "current MDT compatibility baseline must remain documented")
assert(compatibility:find("68e9378b7e894ebdf990f8759657f70c611742fa", 1, true), "MDT 6.2.5 source-review commit must stay pinned")
assert(compatibility:find("preserveExistingTargetMarkers", 1, true), "MDT 6.2.5 Focus Marker preserve-existing contract must stay documented")
