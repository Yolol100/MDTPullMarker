...
Addon.Constants = {
  ...
  AutomaticTargetingWarning = "|cffffad33A marked mob name is ambiguous elsewhere in this MDT route: WoW cannot safely address the intended physical clone automatically. This pull is parked instead of risking a wrong marker.|r",
  MarkerNames = {
    [1] = "Star",
    [2] = "Circle",
    [3] = "Diamond",
