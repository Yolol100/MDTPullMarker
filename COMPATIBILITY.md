...
Current owner safety requires the rc52+ protocol generation. Older builds can disagree about deterministic owner selection. rc58 detects a live pre-rc52 peer and keeps the current client passive instead of risking two active marker owners.
